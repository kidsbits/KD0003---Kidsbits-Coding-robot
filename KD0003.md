# **KD0003 Kidsbits coding robot**

![](Arduino/media/ae5cec34eea3f46f380f724f86a00186.jpg)

## **1.Description**

Kidsbits coding robot, aiming at cultivate children’s
...
-   Dimensions (including wheels): 92mmx105mmx95mm
...
|----|--------------------------------------|-----|----------------------------------------------------------|
| 1  | Kidsbits Coding Robot                | 1   | ![](Arduino/media/40ca723ac5698b2b59c9c415aef89f8f.jpeg) |
| 2  | Kidsbits Push Button Module          | 1   | ![](Arduino/media/b77ff44596242067728f2ba17d1d6e5f.png)          |
| 3  | Kidsbits 7-color Flashing LED Module | 1   | ![](Arduino/media/cc330414cc7dee613007b751555953ee.png)          |
...
| 6  | AM/BM Blue USB Cable                 | 1   | ![](Arduino/media/c2f7a25fc33ed3bb8bf1f1f1f0b51dc3.png)          |
...
![](Arduino/media/7114e5effb352929f8cc3eedb652015a.jpeg) Then right-click on the
USB2.0-Serial and select the top menu option (Update Driver Software...) shown
as the figure below.

![](Arduino/media/e8addf0cc5b62869d377a3abaaa095fc.png)
...
![](Arduino/media/8b4b1669fdc84e15f13539f495a63fd1.png)

After that, select the option to browse and navigate to the “drivers” folder of
usb-ch341 installation.

![](Arduino/media/c880f1da47555a533bf75623228c9bd0.png)
...
![](Arduino/media/170b38d82b3242a333e2e205ac4f3ab9.png)
...
![](Arduino/media/99b5c00a30cda73cfc396f10ea96f34e.png)

  **Arduino IDE Setting**

Click![](Arduino/media/675ae7298ce0973df720b2fbbb514caa.png)icon，and open Arduino IDE.

![](Arduino/media/d3d6a52baca152ccf901a8fd69961669.png)
...
![](Arduino/media/c7d83a7f84f264ddc26b84bd540fbc19.png)

Then select the correct COM port (you can see the corresponding COM port after
the driver is successfully installed)

![](Arduino/media/8653703a2c058bfe67d865b4c8452d0a.png)

![](Arduino/media/f61e28b1add899fa5aae407ab089cbd5.png)

The functions of these symbols are demonstrated below.

![](Arduino/media/5e60b10f8b076212fb1749110aeac96a.png)
...
[![](Arduino/media/f1d5fd3883e0997ca46dcf8513733c46.png)](http://wiki.keyestudio.com/index.php/File:Libraries_1.png)
...
![](Arduino/media/b78da7d6ac05673729051c440cd65558.png)

![](Arduino/media/292b7f008eea29af23661b4a514a75d7.png)

![](Arduino/media/17afa8a3ba35b2d80fd33720498c9275.png)

Then the libraries of Coding robot are installed successfully, as shown below:
...
![](Arduino/media/ac163d92577812e1bcb9fe8afc99c642.png)
...
![](Arduino/media/11f5eb648b0cce24f6ae5fe427770764.jpeg)
...
![](Arduino/media/f6bed4fda51504082f498a2ea0b0c0b7.png)
...
**Preparation:**
  ...
  Slide the Bluetooth switch under the Coding robot to OFF end

  Interface the Coding robot with a computer via a USB cable.
...
![](Arduino/media/4a79470cc28f087a3834d168bc0c343f.jpeg)
...
**![](Arduino/media/fcd9fffd592fd952375db696d1aeee05.jpeg)**![](Arduino/media/06ad902028d4fdf25883486ce4252b07.png)
...
|----------------------------------------------------------|-------------------------------------------------|-------------------------------------------------|
| ![](Arduino/media/40ca723ac5698b2b59c9c415aef89f8f.jpeg) | ![](Arduino/media/cc330414cc7dee613007b751555953ee.png) | ![](Arduino/media/eae591de59355445eb68491c110aa6c1.png) |

When the ambient light is weak, LED will flash and the Coding robot will play
songs
...
![](Arduino/media/d21b657a9955f07694d9a0f7ff5f6dcb.png)
...
![](Arduino/media/8b930c8502ccd8f0e6eeefaf947771fa.jpeg)
...
![](Arduino/media/9296f9187678f03c1551b75780eb5681.png)
...
![](Arduino/media/918ad5d7a83a3533e1ce486fc7d88a3f.png)
...
**![](Arduino/media/b550f1ca473d1702b670b3ca7895f192.jpeg)**
...
![](Arduino/media/df53587ba30d018f86045e7a6dadc7ec.png)
![](Arduino/media/4599e4e126b28b35a6442d70b3bff407.jpeg)
...
### Project 7: 8x8 Dot Matrix Dispaly
...
is called 8x8 dot matrix display. It comes with 64 LEDs, of which can be lit
separately or together. Different lit areas can foster distinct pictures

**![](Arduino/media/1bf7d5e8aad5a25b02212d6c20ac17a8.jpeg)8x8 Dot Matrix**
...
![](Arduino/media/df08c3a7c84497e429ce6fde7253d9b3.jpeg)
...
![](Arduino/media/6576aff8e8a7fb35335629c2f60de29b.jpeg)

The definition inner pins are shown below:

![](Arduino/media/4b98c449bae6648d7719a58d9ab2efa7.jpeg)
...
commons) with a 13x3 (MAX.) matrix key scan circuit. The software configuration
...
![](Arduino/media/fa5b7bd0d5ce98dbd4cb392dfb0b95e7.png)

We design the drive module of 8x8 dot matrix based on the above principle. We
could control the dot matrix by I2C communication and two pins of
microcontroller, according to the above diagram.

**Specification of 8x8 dot matrix**
...
![](Arduino/media/354693b5679a2615c62e99b7025d6355.png)

② The dot matrix is 8x8 in this project, so set the height to 8, width to 8, as
shown below.

![](Arduino/media/501ba516e4be9c8ec4ca6f37e2b6915f.png)
...
![](Arduino/media/d54bce7b6fd3072f496d3b1c2ee367ed.png)
...
**Special note：**
 ...
 When testing, first open the white lens, you can see the rectangular sensing
part. When the long line of the rectangular sensing part is parallel to the
ground, the distance is the best.

 When testing, the sensor needs to be covered with white lens, otherwise it
will affect the distance.

 The distance is best at 25℃, and the detection distance is shortened when it
exceeds 30℃.

![](Arduino/media/14aecf51f85da3da15897d7743980bdc.jpeg)4. Done
...
Upload test code, the Coding robot will display lit LEDs gradually when
...
![](Arduino/media/65a1c1055a2c5f96837006602dc1e70b.jpeg)
...
![](Arduino/media/59c355c3a96942af4e04b6dba5d0e3c9.jpeg)

![](Arduino/media/d29c7f857e56e1d3879fd935164152f5.jpeg)

Download and open it.

![](Arduino/media/84e7a6cf23ae9ab3c5b876e54e25ed74.png)
...
![](Arduino/media/252b02f080ca4181c78422f9766dda27.png)
...
|----------------------------------------------------------------------------------|--------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------|
| ![Screenshot_2019-06-17-08-21-55-51](Arduino/media/48aa4aeaa4494f2ec757416cfdd4fc9b.png) | Enter Bluetooth control interface                                  |                                                                                                                                               |
| ![Screenshot_2019-06-17-08-21-55-51](Arduino/media/48aa4aeaa4494f2ec757416cfdd4fc9b.png) | Disconnect Bluetooth                                               |                                                                                                                                               |
| ![](Arduino/media/c3a35e7f8a877400cbb1ed348bfbe521.png)                                  | Press it to output F； Release it to output S                      | Go forward Stop                                                                                                                               |
| ![](Arduino/media/e6ab1ec1ab00c8d455e109459d62e08d.png)                                  | Press it to output B； Release it to output S                      | Go back Stop                                                                                                                                  |
...
| ![](Arduino/media/b9df3b109b1f3320f55e41bd524d9c9d.png)                                  | Press it to output X； Release it to send X；                      | Start line tracking function； click![](Arduino/media/a36a60c1684cc35676bb7497a8952fbe.png)to end this function                                       |
...
|                                                                                  | ![](Arduino/media/80d740fbf23de7f477eb0bac840d62f7.png)                    | Press it to emit “do1”， Release it to send S                                                                                                 |
...
|                                                                                  | ![](Arduino/media/1eafff05559eecf07635f3c0fe41bdd2.png)                    | Press it to emit “la”， Release it to send S                                                                                                  |
...
|                                                                                  | ![](Arduino/media/da8d6bc1d838fba43b5e192a103798ae.png)                    | Send P，buzzer will play music                                                                                                                |
...
## **8.Resource:**
  ...
  **Download code, libraries and Arduino IDE:**
  ...
  [KD0003](https://kd.kidsbits.cc/KD0003)
